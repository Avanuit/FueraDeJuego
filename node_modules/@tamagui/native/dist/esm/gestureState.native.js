...
function warnGestureEnabledMutationIgnored(source) {
  var freezeState = getGestureEnabledFreezeState();
  ...
  return {
    ...
    createPressGesture(config) {
      ...
      var schedulePressIn = function (e) {
        ...
        flags.pressInTimer = setTimeout(function () {
          flags.pressInTimer = null;
          if (isOwner()) {
            firePressIn(e);
          }
...
export { canChangeGestureHandlerEnabled, claimExternalPressOwnership, getGestureHandler, releaseExternalPressOwnership };
