...
function setupGestureHandler(config) {
  ...
  if (config) {
    ...
    if (config.pressEvents !== void 0 && !(0, import_gestureState.canChangeGestureHandlerEnabled)(config.pressEvents !== false, "setupGestureHandler()")) {
      currentConfig = {
        ...currentConfig,
        pressEvents: (0, import_gestureState.getGestureHandler)().isEnabled
      };
    }
  }
