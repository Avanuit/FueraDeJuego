...
function createComponent(staticConfig) {
  ...
  var component = /* @__PURE__ */import_react.default.forwardRef(function (propsIn, forwardedRef) {
    ...
    if (animationDriver === null || animationDriver === void 0 ? void 0 : animationDriver.avoidReRenders) (0, import_constants.useIsomorphicLayoutEffect)(function () {
...
If you meant to do this, you can disable this warning - either change untilMeasured and group at the same time, or do group={conditional ? 'name' : undefined}`);
  ...
  function styleable(Component2, options) {
    ...
    if (extendedConfig.memo || process.env.TAMAGUI_MEMOIZE_STYLEABLE) out = /* @__PURE__ */import_react.default.memo(out);
