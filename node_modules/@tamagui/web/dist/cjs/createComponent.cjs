...
function createComponent(staticConfig) {
  ...
  const component = import_react.default.forwardRef((propsIn, forwardedRef) => {
    ...
    if (animationDriver?.avoidReRenders) (0, import_constants.useIsomorphicLayoutEffect)(() => {
...
If you meant to do this, you can disable this warning - either change untilMeasured and group at the same time, or do group={conditional ? 'name' : undefined}`);
    ...
    if (!isPassthrough && groupContext && props.containerType !== "normal") nonTamaguiProps.onLayout = (0, import_helpers.composeEventHandlers)(nonTamaguiProps.onLayout, e => {
    ...
    viewProps = import_setupHooks.hooks.usePropsTransform?.(elementType, nonTamaguiProps, stateRef, stateRef.current.willHydrate) || nonTamaguiProps;
  ...
  function styleable(Component2, options) {
    ...
    if (extendedConfig.memo || process.env.TAMAGUI_MEMOIZE_STYLEABLE) out = import_react.default.memo(out);
